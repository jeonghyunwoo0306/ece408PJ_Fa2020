...
#define TILEWIDTH1 16 //TODO: Choose best width for layer1
#define TILEWIDTH2 17 //TODO: Choose best width for layer2
#define X_tile_width1 22 //TODO: Fill this based on TILEWIDTH1
#define X_tile_width2 23 //TODO: Fill this based on TILEWIDTH2
...
__global__ void conv_forward_kernel1(float *y, const float* __restrict__ x)
{
    ...
    */
    ...
    #define H_out 80
    #define W_out 80
    #define W_grid 5  //TODO: Need to add this: ceil(W_out/TILEWIDTH1)
